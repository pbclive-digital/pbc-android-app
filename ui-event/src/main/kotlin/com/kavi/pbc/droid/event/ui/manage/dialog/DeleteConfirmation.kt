...
private fun DeleteConfirmationContent(onAgree: () -> Unit, onDisagree: () -> Unit) {
    Box (
        ...
        Column {
            Text(
                text = stringResource(com.kavi.pbc.droid.event.R.string.label_event_delete_confirmation),
                fontSize = 24.sp,
            ...
            Text(
                ...
                text = stringResource(com.kavi.pbc.droid.event.R.string.phrase_event_delete_confirmation),
                fontSize = 18.sp,
                fontFamily = PBCFontFamily,
