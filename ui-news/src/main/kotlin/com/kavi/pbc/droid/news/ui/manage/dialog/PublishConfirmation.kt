package com.kavi.pbc.droid.news.ui.manage.dialog
...
private fun PublishConfirmationContent(onAgree: () -> Unit, onDisagree: () -> Unit) {
    Box (
        ...
        Column {
            Text(
                text = stringResource(R.string.label_news_publish_confirmation),
                fontSize = 24.sp,
            ...
            Text(
                ...
                text = stringResource(R.string.phrase_news_publish_confirmation),
                fontSize = 18.sp,
                fontFamily = PBCFontFamily,
